...
const Insights = () => {
    ...
    return (
        <div className="space-y-8 fade-in-up">
            {/* Header */}
            <h1 className="text-3xl font-light tracking-tight text-gray-900">Insights</h1>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm min-h-[60vh] flex flex-col items-center justify-center text-center p-8">
                ...
                <div className="space-y-4 max-w-md mx-auto">
                    <div className="space-y-2">
                        ...
                        <h2 className="text-2xl text-gray-900 font-light">Performance Analytics</h2>
                    </div>

                    <p className="text-sm text-gray-400 leading-relaxed font-light">
                        Advanced data visualization tools are being calibrated. Comprehensive sales and traffic insights will be available soon.
                    </p>
